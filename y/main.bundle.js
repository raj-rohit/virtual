...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.signInWithGoogle = function () {
        var _this = this;
        return this._firebaseAuth.auth.signInWithPopup(new __WEBPACK_IMPORTED_MODULE_3_firebase_app__["auth"].GoogleAuthProvider()).then(function (res) {
            // alert(res.user.ca);
            console.log(res.user.ca);
            _this._router.navigate(['/stud']);
        });
    };
